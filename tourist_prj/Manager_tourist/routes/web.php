...
Route::prefix('/tour')->group(function () {
    ...
    // Order Tour
    Route::get('/order', [OrderManagerController::class, 'listOrderTour'])->name('order.tour');
    Route::get('/order/edit/{id}', [OrderManagerController::class, 'editOrderTour'])->name('order.tour.edit');
    Route::put('/order/update', [OrderManagerController::class, 'updateOrderTour'])->name('order.tour.update');
    Route::get('/order/destroy/{id}', [OrderManagerController::class, 'destroySchedule'])->name('order.tour.delete');
});
// POst
...
Route::prefix('/user')->group(function () {
    Route::get('/', [ManagerUserController::class, 'index'])->name('user.index');
    Route::post('/store', [ManagerUserController::class, 'store'])->name('user.store');
    Route::get('/edit/{id}', [ManagerUserController::class, 'edit'])->name('user.edit');
    Route::put('/update', [ManagerUserController::class, 'update'])->name('user.update');
    Route::get('/delete/{id}', [ManagerUserController::class, 'destroy'])->name('user.destroy');
});
